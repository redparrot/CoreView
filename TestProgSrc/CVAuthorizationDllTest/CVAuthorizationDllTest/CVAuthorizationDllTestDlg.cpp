// CVAuthorizationDllTestDlg.cpp : 实现文件
//
...
// CCVAuthorizationDllTestDlg 对话框
...
// CCVAuthorizationDllTestDlg 消息处理程序
...
void CCVAuthorizationDllTestDlg::OnBnClickedOk()
{
	...
	CString Msg;
	Msg.Format("IsAuthorizedStation耗时:%dms, 返回值 = %d", t2 - t1, b);
	TRACE(Msg);
	MessageBox(Msg, "提示:", MB_OK);
}

//GetPOCAuthorizeInfo按钮
void CCVAuthorizationDllTestDlg::OnBnClickedOk2()
{
	...
	CString Msg;
	Msg.Format("GetPOCAuthorizeInfo耗时:%dms\n\
HISTMax = %d\n\
